...
import { Activity, Mail, Lock, Eye, EyeOff, CircleAlert as AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050d1a] bg-grid-pattern flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Your Rehabilitation Journey Starts Here</p>
        </div>
